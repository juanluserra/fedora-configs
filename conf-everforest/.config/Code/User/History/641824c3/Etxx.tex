...
Es necesario generar una entrada sintética para generar un contexto en la primero versión.

\begin{lstlisting}[caption={Ejemplo de código Python}, label={cod:ejemplo}]
    def hola_mundo():
        print("¡Hola desde LaTeX!")  # Comentario
\end{lstlisting}
