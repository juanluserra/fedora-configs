...
% Definir subsubsubsection CORREGIDO
...
% Ajustar profundidad de secciones
\setcounter{secnumdepth}{4} % Para numerar hasta subsubsubsection
\setcounter{tocdepth}{4}     % Para incluir hasta subsubsubsection en el TOC

% Configurar hyperref para nuevos niveles
\hypersetup{
    bookmarksdepth=4 % Aceptar hasta subsubsubsection
}
...
\subsubsubsection{Métodos de grabación}
