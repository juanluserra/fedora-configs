...
\begin{itemize}
    \item \textbf{Electroencefalografía (EEG):} Se mide la actividad electrofísica del cerebro. Es especialmente sensible a corrientes extracelulares. 
    \item \textbf{Resonancia magnética funcional (fMRI):} Se mide la actividad hemodinámica del cerebro. Es especialmente sensible a la concentración de oxígeno en la sangre.
\end{itemize}
